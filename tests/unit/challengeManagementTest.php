...
class challengeManagementTest extends \Codeception\Test\Unit
{
    ...
    public function testValidateFile()
    {
      ...
      $file_info = array("name"=>"testimage.jpg", "type"=>"image/jpg", "tmp_name"=>"/home/testuser/test_assets/testimage.jpg", "error"=>"0", "size"=>"10");
    ...
    public function testEditChallengeName() {
      ...
      $old_challenge_name = $old_challenge_obj->name;
      ...
      $this->assertEquals($new_challenge_name, $new_challenge_obj->name);
    ...
    public function testEditChallengeMoves() {
      ...
      $old_challenge_moves = $old_challenge_obj->number_of_moves;
      ...
      // Assert new challenge object name is equals to test challenge name
      $this->assertEquals($new_challenge_moves, $new_challenge_obj->number_of_moves);
    ...
    public function testEditChallengeFile() {
      ...
      $old_challenge_file = $old_challenge_obj->filepath;
      ...
      // Assert new challenge object name is equals to test challenge name
      $this->assertEquals($new_challenge_file, $new_challenge_obj->filepath);
    ...
    {
      $challenge_id = "1";
      $number_of_moves = $this->challengeManagementObj->search_challenge($challenge_id)->number_of_moves;
